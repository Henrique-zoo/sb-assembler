...
//!
//! Este módulo recebe uma [`crate::assembler::preprocessor::ir::MacroCall`] já validada
...
use crate::{
    assembler::errors::{MacroCallSemanticErrorKind, PreprocessorError, PreprocessorErrorKind},
...
impl Preprocessor<'_> {
    ...
    pub(in crate::assembler::preprocessor) fn execute_macro_call(
        &self,
    ...
    /// [`crate::assembler::errors::PreprocessorErrorKind::InvalidMacroCallSemantic`].
