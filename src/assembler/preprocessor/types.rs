...
use crate::{
    ...
    assembler::preprocessor::ir::Macro,
};
...
impl LogicalLine {
    ...
    pub(in crate::assembler::preprocessor) fn span(&self) -> Span {
...
pub(in crate::assembler::preprocessor) struct LogicalLines {
    tokens: IntoIter<Token>,
    current_line: Vec<Token>,
}

/// Iterador usado pelo orquestrador para percorrer linhas lógicas sob demanda.
pub(in crate::assembler::preprocessor) type LogicalLineIter = Peekable<LogicalLines>;
...
pub(in crate::assembler::preprocessor) trait IntoLogicalLines {
...
#[derive(Debug, Clone, Copy)]
pub(in crate::assembler::preprocessor) enum EquReplacement {
...
impl EquReplacement {
    ...
    pub(in crate::assembler::preprocessor) fn from_numeric_literal(
        literal: crate::assembler::language::numeric_literals::NumericLiteral,
    ) -> Self {
        match literal.sign {
    ...
    pub(in crate::assembler::preprocessor) fn number_symbol(self) -> Symbol {
        match self {
    ...
    pub(in crate::assembler::preprocessor) fn evaluate(
        self,
        interner: &Interner,
    ...
    pub(in crate::assembler::preprocessor) fn to_tokens_with_span(self, span: Span) -> Vec<Token> {
        match self {
