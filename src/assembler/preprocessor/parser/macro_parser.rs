...
impl Preprocessor<'_> {
    ...
    pub(in crate::assembler::preprocessor) fn parse_macro_header(
        &mut self,
        line: &[Token],
    ...
    pub(in crate::assembler::preprocessor) fn parse_endmacro_line(
        &mut self,
        line: &[Token],
        terminator: Token,
    ...
    pub(in crate::assembler::preprocessor) fn parse_macro_body_line(
        &mut self,
        line: &[Token],
        terminator: Token,
